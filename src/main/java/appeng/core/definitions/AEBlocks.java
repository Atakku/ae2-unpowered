...
public final class AEBlocks {
    ...
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_1M = craftingBlock("1m Crafting Storage", AEBlockIds.CRAFTING_STORAGE_1M, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_1M), () -> AEItems.CELL_COMPONENT_1M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_4M = craftingBlock("4m Crafting Storage",AEBlockIds.CRAFTING_STORAGE_4M, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_4M), () -> AEItems.CELL_COMPONENT_4M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_16M = craftingBlock("16m Crafting Storage", AEBlockIds.CRAFTING_STORAGE_16M, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_16M), () -> AEItems.CELL_COMPONENT_16M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_64M = craftingBlock("64m Crafting Storage", AEBlockIds.CRAFTING_STORAGE_64M, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_64M), () -> AEItems.CELL_COMPONENT_64M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_256M = craftingBlock("256m Crafting Storage", AEBlockIds.CRAFTING_STORAGE_256M, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_256M), () -> AEItems.CELL_COMPONENT_256M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_1G = craftingBlock("1g Crafting Storage", AEBlockIds.CRAFTING_STORAGE_1G, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_1G), () -> AEItems.CELL_COMPONENT_1G);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_4G = craftingBlock("4g Crafting Storage",AEBlockIds.CRAFTING_STORAGE_4G, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_4G), () -> AEItems.CELL_COMPONENT_4G);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_16G = craftingBlock("16g Crafting Storage", AEBlockIds.CRAFTING_STORAGE_16G, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_16G), () -> AEItems.CELL_COMPONENT_16G);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_64G = craftingBlock("64g Crafting Storage", AEBlockIds.CRAFTING_STORAGE_64G, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_64G), () -> AEItems.CELL_COMPONENT_64G);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_256G = craftingBlock("256g Crafting Storage", AEBlockIds.CRAFTING_STORAGE_256G, () -> new CraftingUnitBlock(defaultProps(Material.METAL), CraftingUnitType.STORAGE_256G), () -> AEItems.CELL_COMPONENT_256G);
