...
final class SiteExportScenes {
    ...
    public static List<Scene> createScenes() {
        ...
        Collections.addAll(
                ...
                singleBlock(AEBlocks.CRAFTING_STORAGE_1M, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_4M, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_16M, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_64M, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_256M, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_1G, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_4G, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_16G, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_64G, craftingStorageState),
                singleBlock(AEBlocks.CRAFTING_STORAGE_256G, craftingStorageState),
